 ...
 * @status
 */
public class integration implements TalendJob {
	...
	private final String jobName = "integration";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(integration.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class serviceOKStruct implements routines.system.IPersistableRow<serviceOKStruct> {
		final static byte[] commonByteArrayLock_TP1_integration = new byte[0];
		static byte[] commonByteArray_TP1_integration = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final serviceOKStruct other = (serviceOKStruct) obj;
		...
		public void copyDataTo(serviceOKStruct other) {

			other.service_id = this.service_id;
			other.service_nom = this.service_nom;
			other.categorie_nom = this.categorie_nom;

		}

		public void copyKeysDataTo(serviceOKStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_integration.length) {
					if (length < 1024 && commonByteArray_TP1_integration.length == 0) {
						commonByteArray_TP1_integration = new byte[1024];
					} else {
						commonByteArray_TP1_integration = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_integration, 0, length);
				strReturn = new String(commonByteArray_TP1_integration, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_integration) {
				...
				try {
					...
					this.service_nom = readString(dis);

					this.categorie_nom = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.service_nom, dos);

				// String

				writeString(this.categorie_nom, dos);
		...
		public String toString() {
			...
			sb.append(",service_nom=" + service_nom);
			sb.append(",categorie_nom=" + categorie_nom);
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(serviceOKStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public String toString() {
			...
			sb.append("service_id=" + String.valueOf(service_id));
			sb.append(",service_nom=" + service_nom);
			sb.append(",cat_id=" + String.valueOf(cat_id));
			sb.append("]");
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				serviceOKStruct serviceOK = new serviceOKStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "serviceOK");
				}
				...
				String tableName_tDBOutput_1 = "dim_service";
				...
				if (dbProperties_tDBOutput_1 == null || dbProperties_tDBOutput_1.trim().length() == 0) {
					url_tDBOutput_1 = "jdbc:mariadb://" + "127.0.0.1" + ":" + "3306" + "/" + "ssii-unica" + "?"
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:jHVTyjy8bBpMz6FrM7B07JyoZqwFob5vwypFwg==");
				...
				String replace_tDBOutput_1 = "REPLACE INTO `" + "dim_service"
						+ "` (`service_id`,`service_nom`,`categorie_nom`) VALUES (?,?,?)";
...
// # Outputs initialization
				serviceOKStruct serviceOK_tmp = new serviceOKStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Files/Talend-Workstation/TP1/Data/service.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/service.csv", "US-ASCII", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"service_id", "row1", temp, ex_tFileInputDelimited_1),
							...
							row1.service_nom = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.cat_id = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"cat_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
								...
								row2HashKey.cat_id = row1.cat_id;
							...
							if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row2.cat_id = '" +
								// row2HashKey.cat_id + "'");
							} // G 071
...
// # Output table : 'serviceOK'
								serviceOK_tmp.service_id = row1.service_id;
								serviceOK_tmp.service_nom = row1.service_nom;
								serviceOK_tmp.categorie_nom = row2.cat_nom;
								serviceOK = serviceOK_tmp;
// ###############################
...
// Start of branch "serviceOK"
							if (serviceOK != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "serviceOK");
								}

								whetherReject_tDBOutput_1 = false;
								pstmt_tDBOutput_1.setInt(1, serviceOK.service_id);

								if (serviceOK.service_nom == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, serviceOK.service_nom);
								}

								if (serviceOK.categorie_nom == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, serviceOK.categorie_nom);
								}

								int replaceCount_tDBOutput_1 = 0;
								try {
									replaceCount_tDBOutput_1 = pstmt_tDBOutput_1.executeUpdate();
								} catch (java.lang.Exception e) {
					...
					if (!((Object) ("C:/Files/Talend-Workstation/TP1/Data/service.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "serviceOK");
				}
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.cat_nom = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.cat_nom, dos, oos);
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_2 - inputs:(row1,row2) outputs:(serviceOK)
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Files/Talend-Workstation/TP1/Data/categorie.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/categorie.csv", "US-ASCII", ";", "\n", false, 1,
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row2.cat_nom = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.cat_id = row2.cat_id;

							row2_HashRow.cat_nom = row2.cat_nom;
					...
					if (!((Object) ("C:/Files/Talend-Workstation/TP1/Data/categorie.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_3 = "dim_client";
				...
				if (dbProperties_tDBOutput_3 == null || dbProperties_tDBOutput_3.trim().length() == 0) {
					url_tDBOutput_3 = "jdbc:mariadb://" + "127.0.0.1" + ":" + "3306" + "/" + "ssii-unica" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
				...
				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:YMa1vw5I20a8BED6Fo1EFmmQIlYMw+xbT2ibvg==");
				...
				String insert_tDBOutput_3 = "INSERT INTO `" + "dim_client"
						+ "` (`client_id`,`client_nom`,`client_ville`,`client_pays`,`etat_nom`) VALUES (?,?,?,?,?)";
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "C:/Files/Talend-Workstation/TP1/Data/client.csv";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/client.csv", "ISO-8859-4", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"client_id", "row3", temp, ex_tFileInputDelimited_3),
							...
							row3.client_nom = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 2;

							row3.client_ville = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 3;

							row3.etat_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pays_id", "row3", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
// Start of branch "row3"
						if (row3 != null) {
							...
							if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row4.pays_id = '" +
								// row4HashKey.pays_id + "'");
							} // G 071
							...
							if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row5.etat_id = '" +
								// row5HashKey.etat_id + "'");
							} // G 071
...
// Start of branch "clientOK"
							if (clientOK != null) {
								...
								pstmt_tDBOutput_3.setInt(1, clientOK.client_id);

								if (clientOK.client_nom == null) {
									pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(2, clientOK.client_nom);
								}

								if (clientOK.client_ville == null) {
									pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(3, clientOK.client_ville);
								}

								if (clientOK.client_pays == null) {
									pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(4, clientOK.client_pays);
								}

								if (clientOK.etat_nom == null) {
									pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(5, clientOK.etat_nom);
								}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "C:/Files/Talend-Workstation/TP1/Data/pays.csv";
					...
					try {
						fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/pays.csv", "UTF-8", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_4 != null && fid_tFileInputDelimited_4.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pays_id", "row4", temp, ex_tFileInputDelimited_4),
							...
							row4.code_alpha3 = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 2;

							row4.code_alpha2 = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 3;

							row4.Nom_ISO = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "C:/Files/Talend-Workstation/TP1/Data/etat.csv";
					...
					try {
						fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/etat.csv", "US-ASCII", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_5 != null && fid_tFileInputDelimited_5.nextRecord()) {
						...
						try {
							...
							row5.etat_nom = fid_tFileInputDelimited_5.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 1;

							row5.etat_id = fid_tFileInputDelimited_5.get(columnIndexWithD_tFileInputDelimited_5);
...
String tableName_tDBOutput_2 = "dim_agence";
...
java.sql.Connection conn_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cGo+Z1SKEih/NtzNEKN0dD0JLNqGqbpBvPTGOQ==");
...
int count_tDBOutput_2=0;
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "dim_agence" + "` (`agence_id`,`agence_nom_ville`,`agence_pays`,`zone_nom`,`zone_id`) VALUES (?,?,?,?,?)";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_6 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_6 = "C:/Files/Talend-Workstation/TP1/Data/agence.csv";
			...
			if(footer_value_tFileInputDelimited_6 >0 || random_value_tFileInputDelimited_6 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_6 = new org.talend.fileprocess.FileInputDelimited("C:/Files/Talend-Workstation/TP1/Data/agence.csv", "US-ASCII",";","\n",false,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_6 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"agence_id", "row6", temp, ex_tFileInputDelimited_6), ex_tFileInputDelimited_6));
								}
					...
					columnIndexWithD_tFileInputDelimited_6 = 1;
							...
							row6.agence_nom = fid_tFileInputDelimited_6.get(columnIndexWithD_tFileInputDelimited_6);
						
				
					columnIndexWithD_tFileInputDelimited_6 = 2;
					
							row6.agence_ville = fid_tFileInputDelimited_6.get(columnIndexWithD_tFileInputDelimited_6);
					...
					columnIndexWithD_tFileInputDelimited_6 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"pays_id", "row6", temp, ex_tFileInputDelimited_6), ex_tFileInputDelimited_6));
								}
					...
					columnIndexWithD_tFileInputDelimited_6 = 4;
							...
							row6.Zone_id = fid_tFileInputDelimited_6.get(columnIndexWithD_tFileInputDelimited_6);
...
if(Agence != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                            pstmt_tDBOutput_2.setInt(1, Agence.agence_id);

                            if(Agence.agence_nom_ville == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, Agence.agence_nom_ville);
}

                            if(Agence.agence_pays == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, Agence.agence_pays);
}

                            if(Agence.zone_nom == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, Agence.zone_nom);
}

                            if(Agence.zone_id == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, Agence.zone_id);
}
	...
	public void tFileInputDelimited_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_3 - inputs:(row6,row7,row8) outputs:(Agence)
				...
				try {
					...
					Object filename_tFileInputDelimited_8 = "C:/Files/Talend-Workstation/TP1/Data/zone.csv";
					...
					try {
						fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/zone.csv", "US-ASCII", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_8 != null && fid_tFileInputDelimited_8.nextRecord()) {
						...
						try {
							...
							row7.zone_id = fid_tFileInputDelimited_8.get(columnIndexWithD_tFileInputDelimited_8);

							columnIndexWithD_tFileInputDelimited_8 = 1;

							row7.zone_nom = fid_tFileInputDelimited_8.get(columnIndexWithD_tFileInputDelimited_8);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_9 = "C:/Files/Talend-Workstation/TP1/Data/pays.csv";
					...
					while (fid_tFileInputDelimited_9 != null && fid_tFileInputDelimited_9.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pays_id", "row8", temp, ex_tFileInputDelimited_9),
							...
							row8.code_alpha3 = fid_tFileInputDelimited_9.get(columnIndexWithD_tFileInputDelimited_9);

							columnIndexWithD_tFileInputDelimited_9 = 2;

							row8.code_alpha2 = fid_tFileInputDelimited_9.get(columnIndexWithD_tFileInputDelimited_9);

							columnIndexWithD_tFileInputDelimited_9 = 3;

							row8.Nom_ISO = fid_tFileInputDelimited_9.get(columnIndexWithD_tFileInputDelimited_9);
	...
	public static class TempsStruct implements routines.system.IPersistableRow<TempsStruct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.temps_id == null) ? 0 : this.temps_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.temps_id == null) {
				if (other.temps_id != null)
					return false;

			} else if (!this.temps_id.equals(other.temps_id))
		...
		public int compareTo(TempsStruct other) {
			...
			returnValue = checkNullsAndCompare(this.temps_id, other.temps_id);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbProperties_tDBOutput_4 == null || dbProperties_tDBOutput_4.trim().length() == 0) {
					url_tDBOutput_4 = "jdbc:mariadb://" + "127.0.0.1" + ":" + "3306" + "/" + "ssii-unica" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
				...
				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:tPyD0xp8VzdnsRIV2GUK5bSYDgBKc0WxEBNduQ==");
				...
				String insert_tDBOutput_4 = "INSERT INTO `" + "dim_temps"
						+ "` (`temps_id`,`jour`,`mois`,`annee`,`jour_nom`,`mois_nom`) VALUES (?,?,?,?,?,?)";
...
// ###############################
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.contrat_date == null) ? 0 : this.contrat_date.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.contrat_date == null) {
							if (other.contrat_date != null)
								return false;

						} else if (!this.contrat_date.equals(other.contrat_date))
				...
				try {
					...
					Object filename_tFileInputDelimited_10 = "C:/Files/Talend-Workstation/TP1/Data/contrat.csv";
					...
					try {
						fid_tFileInputDelimited_10 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Files/Talend-Workstation/TP1/Data/contrat.csv", "US-ASCII", ";", "\n", false, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.contrat_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"contrat_id", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.contrat_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.client_id = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"client_id", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.contrat_montant = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"contrat_montant", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.contrat_montant = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.contrat_date = ParserUtils.parseTo_Date(temp, "dd/MM/yyyy");

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"contrat_date", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.contrat_date = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.service_id = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"service_id", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.service_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.contrat_nbjour = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"contrat_nbjour", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.contrat_nbjour = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.contrat_debut = ParserUtils.parseTo_Date(temp, "dd/MM/yyyy");

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"contrat_debut", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.contrat_debut = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.contrat_fin = ParserUtils.parseTo_Date(temp, "dd/MM/yyyy");

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"contrat_fin", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}

							} else {

								row9.contrat_fin = null;

							}

							columnIndexWithD_tFileInputDelimited_10 = 8;

							row9.devise = fid_tFileInputDelimited_10.get(columnIndexWithD_tFileInputDelimited_10);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row9.agence_id = ParserUtils.parseTo_Integer(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_10) {
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"agence_id", "row9", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}
...
// Start of branch "row9"
						if (row9 != null) {
							...
							row10 = null;
							finder_tUniqRow_1.contrat_date = row9.contrat_date;
							finder_tUniqRow_1.hashCodeDirty = true;
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

								new_tUniqRow_1.contrat_date = row9.contrat_date;
								...
								row10.contrat_id = row9.contrat_id;
								row10.client_id = row9.client_id;
								row10.contrat_montant = row9.contrat_montant;
								row10.contrat_date = row9.contrat_date;
								row10.service_id = row9.service_id;
								row10.contrat_nbjour = row9.contrat_nbjour;
								row10.contrat_debut = row9.contrat_debut;
								row10.contrat_fin = row9.contrat_fin;
								row10.devise = row9.devise;
								row10.agence_id = row9.agence_id;
...
// Start of branch "row10"
							if (row10 != null) {
								...
								{ // start of Var scope
									...
									Var.jour = TalendDate.getPartOfDate("DAY_OF_WEEK", row10.contrat_date);// ###############################
									// ###############################
									// # Output tables
...
// # Output table : 'Temps'
									Temps_tmp.temps_id = row10.contrat_date;
									Temps_tmp.jour = Var.jour;
									Temps_tmp.mois = TalendDate.getPartOfDate("MONTH", row10.contrat_date);
									Temps_tmp.annee = TalendDate.getPartOfDate("YEAR", row10.contrat_date);
									Temps_tmp.jour_nom = Var.jour == 0 ? "Sun"
											: (Var.jour == 1 ? "Mon"
													: (Var.jour == 2 ? "Tue"
															: (Var.jour == 3 ? "Wed"
																	: (Var.jour == 4 ? "Thu"
																			: (Var.jour == 5 ? "Fri" : "Sat")))));
									Temps_tmp.mois_nom = TalendDate.formatDate("MMMM", row10.contrat_date);
									Temps = Temps_tmp;
// ###############################
...
// Start of branch "Temps"
								if (Temps != null) {
									...
									if (Temps.temps_id == null) {
										pstmt_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(1, Temps.temps_id);
									}

									if (Temps.jour == null) {
										pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(2, Temps.jour);
									}

									if (Temps.mois == null) {
										pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(3, Temps.mois);
									}

									if (Temps.annee == null) {
										pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(4, Temps.annee);
									}

									if (Temps.jour_nom == null) {
										pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(5, Temps.jour_nom);
									}

									if (Temps.mois_nom == null) {
										pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(6, Temps.mois_nom);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final integration integrationClass = new integration();

		int exitCode = integrationClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integration.class.getClassLoader()
					.getResourceAsStream("tp1/integration_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = integration.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : integration");
		}
...
/************************************************************************************************
 * 276601 characters generated by Talend Open Studio for Data Integration on the
 * November 24, 2020 12:08:35 PM WET
 ************************************************************************************************/