...
/**
 * Job: job_principal Purpose: Job principal<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class job_principal implements TalendJob {
	...
	private final String jobName = "job_principal";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					job_principal.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_principal.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp1.agence_job_0_1.agence_job childJob_tRunJob_1 = new tp1.agence_job_0_1.agence_job();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp1.client_job_0_1.client_job childJob_tRunJob_2 = new tp1.client_job_0_1.client_job();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp1.service_0_1.service childJob_tRunJob_3 = new tp1.service_0_1.service();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp1.contrat_0_1.contrat childJob_tRunJob_4 = new tp1.contrat_0_1.contrat();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp1.faits_job_0_1.faits_job childJob_tRunJob_5 = new tp1.faits_job_0_1.faits_job();
				// pass DataSources
	...
	public static void main(String[] args) {
		final job_principal job_principalClass = new job_principal();

		int exitCode = job_principalClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_principal.class.getClassLoader()
					.getResourceAsStream("tp1/job_principal_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_principal.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_principal");
		}
...
/************************************************************************************************
 * 74530 characters generated by Talend Open Studio for Data Integration on the
 * November 24, 2020 8:45:37 PM WET
 ************************************************************************************************/